...
start:
   ...
   ld      a, #04       ;; Hay que matar 4 enemigos
   ld (alive), a        ;; Actualizar la variable
   ...
   bucle_animacion:
     ...
     comprueba_R:
      ...
      jr     z, choque  ;; Si (Z inactivo), saltar a choque
      ;; Segundo enemigo
      ...
      ;; Comprueba si no quedan enemigos
      ld     a, (alive) ;; A = Número de enemigos restantes
      cp    #0          ;; ¿A=0?
      jr    z, victoria ;; Sí, hemos acabado con los enemigos, terminar
...
;;============================================================
;; Muestra una explosión y descuenta un enemigo de la cuenta
;; de enemigos vivos.
;; ENTRADAS
;;    HL: Posición donde mostrar la explosión
;; MODIFICA
;;    HL, A, C
;;============================================================
elimina_enemigo:
   ld    a, (alive)      ;; A = Número de enemigos con vida
   dec   a               ;; Uno menos
   ld (alive), a         ;; Actualizar variable
   call anima_disolucion ;; Se disuelve
...
destruccion_de_enemigos:
   ...
   ;; Enemigo 1 golpeado
   call  elimina_enemigo   ;; Elimina al enemigo y muestra explosión
...
mover_a_la_derecha:
   ...
   ;; Impedir movimiento límite derecho
