...
start:
   ...
   ;;
   ld hl, #C375         ;; Primer Barril en C375
   call dibujar_barril  ;; Dibuja un barril
   ld hl, #C3B0         ;; Segundo Barril en C3B0
   call dibujar_barril  ;; Dibuja un barril
   ...
   bucle_animacion:
      ...
      jr    comprueba_R          ;; Impide que pueda moverse también a la izquierda 
                                 ;; (saltando directo a Comprueba_R
      comprueba_O:
      ...
      ;; Comprobar si choca con algún barril. Si es así, explotar
      ld    hl, (pos)   ;; HL = posición de la vagoneta
      ld     a, l       ;; A = L, para poder hacer comprobaciones
      cp   #75          ;; ¿Es L=A=#75? (Posición del barril izquierdo)
      jr     z, choque  ;; Si (Z activo), saltar a Choque
      cp   #B0-1        ;; ¿Es L=A=#BO-1? (Posición del barril derecho)
      jr     z, choque  ;; Si (Z activo), saltar a Choque
   ...
   reiniciar:
      ...
      ld   hl, #C390             ;; Y la reposicionamos al inicio
