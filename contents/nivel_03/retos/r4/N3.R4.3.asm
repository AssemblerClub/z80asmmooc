...
mover_a_la_izquierda:
   ...
   ;; Comprobar si la posición es el borde izquierdo de la pantalla.
   ;; Si es así, no realizar ningún movimiento
   ld     a, l                ;; A = L, para poder hacer comprobaciones
   cp   #70                   ;; ¿Es L=A=#70? (Límite izquierdo de la pantalla)
   jr     z, salir_sin_mover_izquierda ;; Si (Z Activo), volver sin hacer nada
